...
def analyzeResults( x_actual, y_actual, x_measured, y_measured, x_predicted, y_predicted, x_corrected, y_corrected, t ):
    ...
    fig_p = getPlots( x_measured, y_measured, x_actual, y_actual, x_predicted, y_predicted, t, 'predicted' )
    # Plots for corrected positions
    fig_c = getPlots( x_measured, y_measured, x_actual, y_actual, x_corrected, y_corrected, t, 'corrected' )
    return fig_p, fig_c
